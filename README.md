...
To focus my analysis on the France job market, I apply filters to the dataset, narrowing down to roles based in France. I have used a variable for the country in case , I want to use it for other countries

```python
country = 'France'
df_US = df[df['job_country'] == country]
